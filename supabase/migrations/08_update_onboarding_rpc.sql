-- =============================================
-- UPDATE ONBOARDING RPC: Yeni bir tenant ve profil olusturur
-- 14 GÜNLÜK DENEME (TRIAL) SÜRESİ EKLENDİ
-- =============================================
...
BEGIN
    ...
    -- Yeni tenant olustur (14 GÜNLÜK DENEME SÜRESİ İLE)
    INSERT INTO public.tenants (name, slug, plan_type, status, trial_ends_at)
    VALUES (
        p_tenant_name, 
        p_tenant_slug, 
        'deneme', 
    ...
    -- JWT claim (app_metadata.tenant_id) guncellemesi
    UPDATE auth.users 
