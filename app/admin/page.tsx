    ...
    const initTenant = async () => {
      try {
        ...
        if (tenantInfo) {
          ...
          setIsImpersonating(tenantInfo.isImpersonating || false);
        } else {
        ...
        <div className="p-4 border-t">
          ...
          {isImpersonating ? (
            <button 
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-white bg-red-600 hover:bg-red-700 rounded-xl transition-colors text-sm font-semibold shadow-md shadow-red-500/20 mt-2"
            >
