    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-primary/30 flex items-center justify-center p-6 relative overflow-hidden pt-20">
      ...
      <div className="w-full max-w-md relative z-10 my-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 font-medium">14 Günlük Ücretsiz Deneme Başlatın</p>
        </div>

        <Card className="rounded-3xl shadow-2xl border-white/10 bg-white/95 backdrop-blur-xl">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-2xl font-extrabold">Hesap Oluştur</CardTitle>
          ...
          <CardContent className="space-y-6 px-8 pb-8">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-3 text-slate-400 font-bold tracking-wider">veya e-posta ile</span>
              </div>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="font-semibold">Şifre Belirleyin</Label>
                <div className="relative">
        ...
        <p className="text-center mt-6 text-slate-400 text-sm">
          ...
          <Link href="/login" className="text-white hover:text-primary font-bold hover:underline transition-colors">
            Giriş Yapın
          </Link>
        </p>
      </div>
